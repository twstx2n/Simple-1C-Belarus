...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Для Каждого ТекСтрокаТовары Из Товары Цикл
		...
		// Запишем цену поступившего товара в справочник. Пока так реализую.
		СпрНомкенклатура = ТекСтрокаТовары.Номенклатура.ПолучитьОбъект();
		СпрНомкенклатура.СтоимостьПокупки = ТекСтрокаТовары.Цена;
		СпрНомкенклатура.Записать();
