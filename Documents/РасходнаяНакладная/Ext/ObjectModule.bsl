...
#КонецОбласти
	...
	|ИЗ
	|  РегистрНакопления.ОстаткиТоваров.Остатки(&МоментВремени, Склад = &Склад И ЮрЛицо = &ЮрЛицо
	|    И Номенклатура В
	|      (ВЫБРАТЬ 
	|		  ДокТЧ.Номенклатура
	|       ИЗ
	...
	Запрос.Текст = "ВЫБРАТЬ
	                 ...
	                 |			ЮрЛицо = &ЮрЛицо И Номенклатура В
	                 |				(ВЫБРАТЬ
...
#Область БухПоСреднемуПоСкладам
	...
	Запрос.УстановитьПараметр("Счет", ПланыСчетов.ПланСчетов.С41с1);
